            ...
            <div>
              ...
              <p className="text-sm text-yellow-700 mt-1">
                {t('affiliate.pendingCommissionMessage', { 
                  available: availableCommission.toLocaleString(), 
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <p className="text-xs text-gray-500">
                      {t('affiliate.available')} ¥{availableCommission.toLocaleString()} (approved) | 
                      {t('affiliate.minimum')} ¥{minAmount.toLocaleString()} | 
                      Pending: ¥{truePendingCommission.toLocaleString()}
                    </p>
                    <FormMessage />
                  </FormItem>
                )}
